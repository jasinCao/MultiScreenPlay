...
import com.simple.autolayout.attr.MarginAttr;
...
import com.simple.autolayout.attr.PaddingAttr;
...
//            if (!isPxVal(val)) continue;
            ...
            switch (index)
            {
                ...
                case INDEX_WIDTH:
                    ...
                    break;
                case INDEX_HEIGHT:
                	Slog.d("autoinfo", "params.height=============>" + pxVal + " n " + n);
                	Slog.d("autoinfo", "=============>" +new HeightAttr(pxVal, baseWidth, baseHeight));
